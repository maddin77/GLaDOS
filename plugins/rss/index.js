    ...
    onCommand: function(client, server, channel, commandChar, name, params, user, text, message) {
        if(name == "rss") {
            ...
            if(params[0].toLowerCase() == "add") {
                ...
                if(!this.isSubscribed(params[1], nick)) return client.notice(user.getNick(), "You already subscribed to that feed. If you want to unsubscribe, use '"+commandChar + name + " UNSUBSCRIBE "+params[1]+"' instead.");
