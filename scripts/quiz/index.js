...
Quiz.prototype.getHint = function () {
    ...
    if (self.hintcount > self.MAX_HINTS) { //MAX_HINTS
        ...
        self.channel.say('[%s] Automatically solved after %s.', ircC.bold('QUIZ'), time);
        self.channel.say('[%s] The answer is: %s', ircC.bold('QUIZ'), ircC.bold(self.getAnswer()));
        ...
        self.channel.say('[%s] Tipp: %s', ircC.bold('QUIZ'), ircC.bold(hint));
