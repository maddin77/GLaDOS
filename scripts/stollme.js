/* 
    In gedenken an Dr. Axel Stoll († 28/07/2014). Rest in Pepperoni.
*/
"use strict";
...
module.exports = function (scriptLoader, irc) {
    ...
    scriptLoader.registerCommand(['stollme', 'stoll'], function (event) {
        event.channel.say('"' + _.sample(quotes) + '" — Dr. Axel Stoll');
    });
};