# Version 0.3.6 (11.11.2013)
* Bitcoin-Plugin verbessert. Sollte nun (wenn auch nur leicht) schneller sein. Dazu wurde der Befehl etwas ausgebaut, und nimmt nun sowohl `volume` als auch `currency` und `volume currency`/`currency volume` Parameter an.

# Version 0.3.5 (21.10.2013)
